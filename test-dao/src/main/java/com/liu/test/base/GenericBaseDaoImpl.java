...
public class GenericBaseDaoImpl  implements GenericBaseDao {
    ...
    public <E> E executeForObject(String sqlID, Object bindParams, Class<E> clazz) {
        return getForObject(sqlID, bindParams, sqlSession, clazz);
    }

    private <E> E getForObject(String sqlID, Object bindParams, SqlSession sqlSession, Class<E> clazz) {
    ...
    public <E> List<E> executeForObjectList(String sqlID, Object bindParams) {
        return getExecuteForObjectList(sqlID, bindParams, sqlSession);
    }

    private <E> List<E> getExecuteForObjectList(String sqlID, Object bindParams, SqlSession sqlSession) {
        if (log.isDebugEnabled()) {
    ...
    public int execute(String sqlID, Object bindParams) {
        return exexuteBySQLSession(sqlID, bindParams, sqlSession);
    }



    private int exexuteBySQLSession(String sqlID, Object bindParams, SqlSession sqlSession) {
        if (log.isDebugEnabled()) {
